A function which compares two Javascript objects or arrays and determines whether or not they have an "identical structure".  An "identical structure" means:
